...
class UserTest < ActiveSupport::TestCase
  ...
  test "a user can have a correctly formatted profile name" do
    user = User.new(first_name: 'Jason', last_name: 'Andra', email: 'jasonadra@gmail.com')
    user.password = user.password_confirmation = 'asdfasdf'

    user.profile_name = 'jasonandra1010'
    assert user.valid?
  end
  ...
  test "that creating a friendship base on user id and friend id works" do
